...
TOTAL_REQUESTS = Counter(
    "radarmap_total_requests_count", "Total number of tile requests received", registry=REGISTRY
)
...
ACTIVE_REQUESTS = Gauge(
    "radarmap_active_requests", "Number of currently processing tile requests", registry=REGISTRY
)
